function encodeMozlz4(data) {
  ...
  let compressOutput = new Uint8Array(compressBound(encodedData.length));
  let size = compress(encodedData, compressOutput);
  const compressedData = new Uint8Array(compressOutput.buffer.slice(0, size));
...
/**
 * This function's code was taken from node-lz4 by Pierre Curto. MIT license.
...
/**
 * The following code is adapted from node-lz4 by Pierre Curto. MIT license.
 */
...
function compress(src, dst, sIdx, eIdx) {
